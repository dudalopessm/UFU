...
public class UsaBanco {
    public static void main(String[]args) {
        ...
        if (contasEsp[0].debitaValor(1000, 1125)) { // senha aqui é 1122
            ...
            System.out.println("Débito não efetuado. Digite o valor e a senha novamente.");
            ...
            while(valor > contasEsp[0].getSaldo(senha)) {
                System.out.println("Valor a ser debitado maior do que o saldo da conta. Digite o valor novamente: ");
                valor = sc.nextFloat();
            }
            contasEsp[0].debitaValor(valor, senha);
            System.out.println("Débito efetuado com sucesso. Novo saldo: " + contasEsp[0].getSaldo(senha));
        }

        // ------------------------------------------------- SAQUE COM VALOR INCORRETO -------------------------------------------------
        if(contasEsp[1].debitaValor(10000, 1322)) { // valor aqui é 100
            System.out.println("Débito efetuado. Novo saldo: " + contasEsp[1].getSaldo(1322));
        } else {
            System.out.println("Débito não efetuado. Digite o valor e a senha novamente.");
            System.out.println("Valor: ");
            float valor; int senha;
            ...
            System.out.println("Débito efetuado com sucesso. Novo saldo: " + contasEsp[1].getSaldo(senha));
        }

        // ------------------------------------------------- SAQUE BEM SUCEDIDO -------------------------------------------------
        if (contasEsp[2].debitaValor(100, 1124)) {
            System.out.println("Débito efetuado. Novo saldo: " + contasEsp[2].getSaldo(1124));
        } else {
            System.out.println("Débito não efetuado. Digite o valor e a senha novamente.");
            System.out.println("Valor: ");
            float valor; int senha;
            ...
            System.out.println("Débito efetuado com sucesso. Novo saldo: " + contasEsp[2].getSaldo(senha));
        }
        ...
        if (contasCom[0].debitaValor(20, 1444)) {
            ...
            if(estado == 1) {
                System.out.println("Débito efetuado. Novo saldo: " + contasCom[0].getSaldo(1444));
            } else if (estado == 2) {
                System.out.println("Débito efetuado e conta desativada devido ao saldo ter sido zerado. Essa conta não poderá mais ser acessada.");
                contasCom[0] = null;
            }
        } else {
            System.out.println("Débito não efetuado. Digite o valor e a senha novamente.");
            ...
            System.out.println("Débito efetuado com sucesso. Novo saldo: " + contasCom[0].getSaldo(senha));
        }
        ...
        if (contasCom[1].debitaValor(200, 4444)) {
            ...
            if(estado == 1) {
                System.out.println("Débito efetuado. Novo saldo: " + contasCom[1].getSaldo(4444));
            } else if (estado == 2) {
                System.out.println("Débito efetuado e conta desativada devido ao saldo ter sido zerado. Essa conta não poderá mais ser acessada.");
                contasCom[1] = null;
            }
            ...
            System.out.println("Débito efetuado com sucesso. Novo saldo: " + contasCom[1].getSaldo(senha));
        }
