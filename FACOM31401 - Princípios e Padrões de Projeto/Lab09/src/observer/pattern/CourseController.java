...
public class CourseController extends JPanel implements Observer, ChangeListener, ActionListener {
	...
	public static void main(String[] args) {
		...
		JScrollPane scrollPie = new JScrollPane(pie,
				JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
				JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
		...
		frame.setResizable(true); // Alterado para permitir redimensionamento
		...
		constraints.gridx = 2;
		constraints.gridy = 0;
		frame.getContentPane().add(scrollPie, constraints);
