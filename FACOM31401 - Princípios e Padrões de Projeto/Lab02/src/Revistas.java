public class Revistas extends Biblioteca {
    ...
    public static void cadastraRevista(int ano, String titulo, String organizacao, int volume, int numero) {
        Revistas r = new Revistas(ano, titulo, organizacao, volume, numero);
