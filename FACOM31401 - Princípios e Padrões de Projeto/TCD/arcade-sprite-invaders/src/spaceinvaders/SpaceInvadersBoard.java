...
public class SpaceInvadersBoard extends AbstractBoard{  
    ...
    // implementações específicas para estilização do tabuleiro que antigamente estavam no framework
    protected void drawGameOver(Graphics2D g) {

        g.setColor(Color.black);
        g.fillRect(0, 0, spriteframework.Commons.BOARD_WIDTH, spriteframework.Commons.BOARD_HEIGHT);

        g.setColor(new Color(0, 32, 48));
        g.fillRect(50, spriteframework.Commons.BOARD_WIDTH / 2 - 30, spriteframework.Commons.BOARD_WIDTH - 100, 50);
        g.setColor(Color.white);
        g.drawRect(50, spriteframework.Commons.BOARD_WIDTH / 2 - 30, spriteframework.Commons.BOARD_WIDTH - 100, 50);
        ...
        g.setColor(Color.white);
        g.setFont(small);
        g.drawString(message, (spriteframework.Commons.BOARD_WIDTH - fontMetrics.stringWidth(message)) / 2,
                spriteframework.Commons.BOARD_WIDTH / 2);
    }
    ...
    protected void drawGameWon(Graphics2D g) {
        ...
        g.drawString("Você ganhou!", freezemonster.Commons.BOARD_WIDTH / 2 - 80, freezemonster.Commons.BOARD_HEIGHT / 2);
    }
    ...
    protected void initBoard() {
        ...
        setFocusable(true);
        d = new Dimension(Commons.BOARD_WIDTH, Commons.BOARD_HEIGHT); // usa valores do jogo original
    ...
    protected void processOtherSprites(Player player, KeyEvent e) {
        // modificar essa função para pegar direção do cowboy e ai sim ele atirar
		int x = player.getX();
		int y = player.getY();
