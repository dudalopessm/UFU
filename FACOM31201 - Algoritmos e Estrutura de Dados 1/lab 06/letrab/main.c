...
int main () {
    ...
    Aluno a15, a16, a17;
    nota1 = maiornota(li1, &a15);
    nota2 = maiornota(li2, &a16);
    nota3 = maiornota(li3, &a17);
    printf("\n\nA maior nota da lista 1 corresponde a: %d, do aluno %s de num. de matricula %d.", nota1, a15.nome, a15.mat);
    printf("\n\nA maior nota da lista 2 corresponde a: %d, do aluno %s de num. de matricula  %d.", nota2, a16.nome, a16.mat);
    printf("\n\nA maior nota da lista 3 corresponde a: %d, do aluno %s num. de de matricula %d.", nota3, a17.nome, a17.mat);
